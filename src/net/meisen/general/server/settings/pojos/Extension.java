...
public class Extension {
	...
	/**
	 * Gets all the <code>Extension</code> instances which are defined within this
	 * instance.
	 * 
	...
	/**
	 * Checks if <code>this</code> instance has an <code>Extension</code> with the
	...
	/**
	 * Sets the <code>List</code> of all the <code>Extension</code> instances for
	 * <code>this</code>. Normally those should be children within
	...
	/**
	 * Gets the <code>Extension</code> instance with the specified <code>id</code>
	 * . This method returns <code>null</code> if no such <code>Extension</code>
	...
	/**
	 * Sets the <code>value</code> of the specified <code>property</code>. If the
	 * property already exists, it will be overridden, if not it will be created.
	 * 
	 * @param property
	 ...
	 * representation used in the XML-definition). The raw value might be equal to
	 * the final value of the property. This is the case, if the property is
